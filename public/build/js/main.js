...
(function () {
  ...
  if (tienda) {
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 7:
              ...
              return _context11.abrupt("return", consulta);
            case 9:
            case "end":
              return _context11.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            ...
            case 7:
              ...
              return _context12.abrupt("return", precios);
            case 9:
            case "end":
              return _context12.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            ...
            case 3:
              ...
              return resultado.json();
            case 6:
              producto = _context13.sent;
              return _context13.abrupt("return", producto);
            case 8:
            case "end":
              return _context13.stop();
          }
    ...
    var actualizarCantidadProductoDelCarrito = /*#__PURE__*/function () {
      var _ref15 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
        ...
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              producto = _args14.length > 0 && _args14[0] !== undefined ? _args14[0] : [];
    ...
    var eliminarProductoDelCarritoDB = /*#__PURE__*/function () {
      var _ref16 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee15(productoId) {
        ...
        return _regeneratorRuntime().wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            ...
            case 6:
              ...
              return _context15.abrupt("return", consulta);
            case 8:
            case "end":
              return _context15.stop();
          }
  ...
  if (usuarioPedidos) {
    var mostrarDetallesPedido = function mostrarDetallesPedido() {
      ...
      pedido.productos.forEach(function (producto) {
        ...
        productoSubtotal.innerText = "$ ".concat(producto.subtotal);

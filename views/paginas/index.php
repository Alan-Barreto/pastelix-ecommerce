<main class="inicio">
    <h1 class="inicio__titulo"> Deliciosos postres para cada ocasión</h1>
    
    <h2 class="inicio__subtitulo">Compra en línea y recibe en tu puerta con un par de clics</h2>
    ...
    <div class="inicio__ventajas">
        <div class="inicio__elemento">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="48" width="48" viewBox="0 0 640 640">
        ...
        <div class="inicio__elemento">  
            ...
            <p>Descuentos <br> para miembros</p>
        </div>
        ...
        <div class="inicio__elemento">  
            ...
            <p>Ingredientes <br> de calidad</p>
        </div>
    </div>
</main>